          ...
          {mode === "otp" ? (
            ...
            <>
              <div style={{ textAlign:"center", marginBottom:20 }}>
                <div style={{ width:52, height:52, background:"#EEF4FF", borderRadius:14,
                  display:"flex", alignItems:"center", justifyContent:"center", margin:"0 auto 12px", fontSize:26 }}>✓</div>
                <h2 style={{ color:"#1E3A5F", margin:"0 0 6px", fontFamily:"'Barlow Condensed',sans-serif", fontSize:22, fontWeight:800 }}>Approval pending</h2>
                <p style={{ color:"#93A8C8", fontSize:13, margin:0 }}>You will get a call within 24 hours from our team.</p>
              </div>
              {pendingGymOwner && (
                <div style={{ background:"#EEF4FF", border:"1.5px solid #DBEAFE", borderRadius:9, padding:"13px 14px", marginBottom:16 }}>
            ...
            <>
              <h2 style={{ color:"#1E3A5F", margin:"0 0 6px", fontFamily:"'Barlow Condensed',sans-serif", fontSize:22, fontWeight:800 }}>Register your GYM</h2>
              <p style={{ color:"#93A8C8", fontSize:13, margin:"0 0 20px" }}>Create your gym owner account</p>
              ...
              <AuthInput label="Password" type="password" value={gymForm.password} onChange={setGym("password")} placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢"/>
              <AuthInput label="City" value={gymForm.city} onChange={setGym("city")} placeholder="Mumbai"/>
              {error && <p style={{ color:"#EF4444", fontSize:13, margin:"-6px 0 14px" }}>{error}</p>}
              <button onClick={handleGymSignup} style={{
                width:"100%", background:"#3B82F6", border:"none", borderRadius:9,
                padding:"12px", color:"#fff", fontSize:15, fontWeight:700,
                cursor:"pointer", fontFamily:"'Barlow Condensed',sans-serif",
            ...
            <>
              ...
              <AuthInput label="Password" type="password" value={gymForm.password} onChange={setGym("password")} placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢"/>
              {error && <p style={{ color:"#EF4444", fontSize:13, margin:"-6px 0 14px" }}>{error}</p>}
              <button onClick={handleGymLogin} style={{
                width:"100%", background:"#3B82F6", border:"none", borderRadius:9,
                padding:"12px", color:"#fff", fontSize:15, fontWeight:700,
                cursor:"pointer", fontFamily:"'Barlow Condensed',sans-serif",
                textTransform:"uppercase", letterSpacing:0.5, marginBottom:12,
